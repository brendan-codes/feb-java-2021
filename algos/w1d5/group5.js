...
class SLL {
    ...
    printSecondToLastValue() {
        ...
        if (tempnode == null || tempNode.next == null)
            tempNode.next;
        //if statement for temp node to see if node=null or node.next=null checking for 1 nodes left
        while (tempNod.next != null) {
            tempNode = tempnode.next;
        }
        //while loop is needed togo through sll to determine if node after temp.next is equal null
        return tempNode
            //return temp node
