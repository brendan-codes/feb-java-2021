...
class BST {
    ...
    delete(val, current) {
        ...
        // ... now what?
        // check if value > current
        // remove right child using recursion
        ...
        // if tree has no right and left (no children)
        // node === null
        // return node
        // if there is no right
        // remove left (node = node.left)
        // return node
        // else if there is no left
        // remove right (node = node.left)
        // return node
        // check for case when there's 2 children, remove the lesser of the two (find smallest in BST)
        ...
        current.right = this.delete(current.right, temp.val);
        return current;
    }
