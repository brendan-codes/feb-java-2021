...
class BST {
    ...
    delete(val, current) {
        ...
        if (current.val === val) {
            var toBeDeleted = current; // <--- node to be deleted
            // if a left exist
            if (current.left) {
        ...
        return this.find(val, current); // up the call stack
...
myBST.insert(new BSTNode(53));
myBST.insert(new BSTNode(69));
myBST.insert(new BSTNode(68));
myBST.insert(new BSTNode(75));
console.log(myBST);
console.log("----------");
myBST.delete(69);