    ...
    delete(val, current = this.root) {
        if(this.root.val == val){
            if(!current.left && !current.right){
                ...
                this.root.val = this.getSmallestFromSubtree(this.root.right).val;
        ...
        while(current){
            if(current.left && val == current.left.val){
                if(!current.left.left && !current.left.right){
                    ...
                    current.left.val = this.getSmallestFromSubtree(current.left.right).val;
                    this.removeSmallest(current.left.right);
                    return;
                }
            } else if(current.right && val == current.right.val){
                if(!current.right.left && !current.right.right){
                    ...
                    current.right.val = this.getSmallestFromSubtree(current.right.right).val;
